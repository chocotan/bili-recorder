...
public class StructFieldData {
	...
	private struct.Constants.Primitive type;
	
	public StructFieldData(Field field, boolean requiresGetterSetter,
			Method getter, Method setter, struct.Constants.Primitive type,
	...
	public struct.Constants.Primitive getType() {
		return type;
	}

	public void setType(struct.Constants.Primitive type) {
		this.type = type;
	}
