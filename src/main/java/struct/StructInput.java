...
public abstract class StructInput extends InputStream {
  ...
  public void readField( StructFieldData fieldData, Method getter, Method setter, Object obj )
              throws IOException, InvocationTargetException, InstantiationException, IllegalAccessException, struct.StructException {
      ...
      if ( !field.getType().isArray() ){
    		  ...
    		  if(setter != null){
    			  ...
    			  if(object == null){
    				  if(field.getName().endsWith("CString")){
    					  throw new struct.StructException("CString objects should be initialized :" + field.getName());
    				  }
    	  ...
    	  if ( getter!= null && getter.invoke(obj,(Object[])null) == null )
    		  throw new struct.StructException("Arrays can not be null : " + field.getName());
    	  switch(fieldData.getType()) {
    	  case BOOLEAN: 
  ...
  public void handleObject(Field field, Object obj)
			throws IllegalArgumentException, struct.StructException, IOException,
			InstantiationException, IllegalAccessException {
		if (field.get(obj) == null) {
			if (field.getType().getName().endsWith("CString")) {
				throw new struct.StructException("CString objects should be initialized before unpacking :"
								+ field.getName());
			}
  ...
  protected abstract void readObjectArray( Object objects[] )throws IOException, struct.StructException;
