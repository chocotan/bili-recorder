...
public class StructPacker extends struct.StructOutput {
	private ByteArrayOutputStream bos;
	protected DataOutput dataOutput;

	protected void init(OutputStream outStream, ByteOrder order) {
		if (order == ByteOrder.LITTLE_ENDIAN) {
			dataOutput = new struct.LEDataOutputStream(outStream);
		} else {
    ...
    public byte[] pack(Object objectToPack) throws struct.StructException {
